...
<div class="legal-overlay" id="legal-overlay">
  <div class="legal-modal">
    ...
    <div class="legal-body">
      <p>欢迎访问"AI 项目教练"（builder.zhexueyuan.com）。本站致力于帮助零基础用户从软件想法出发，一步步完成项目定义、设计书生成、任务拆解，直到产品上线的全过程指导，旨在为用户提供项目规划参考与学习支持。</p>

      <h3>一、声明性质</h3>
      <p>本站提供的内容和工具均为辅助性的项目规划参考工具，主要用于帮助用户梳理想法、生成设计文档与任务清单。本站并非商业性培训机构，亦不构成电信业务经营服务。</p>

      <p>本站提供的访问凭证（注册码），仅作为本在线文档与相关内容的阅读/访问凭证，不构成软件产品销售、预付式消费服务或其他形式的商业功能交付承诺。注册码一经激活，视为已接受本声明全部条款。</p>
      ...
      <h3>3. 外部服务风险</h3>
      <p>本站自身不直接调用任何第三方 AI 服务。用户在使用过程中，需自行前往站外 AI 平台（如 Claude、ChatGPT、DeepSeek、豆包、Kimi、通义千问等）进行操作。相关第三方平台的可用性、稳定性、访问速度、政策调整与功能变化，不受本站控制。因第三方平台限制、服务中断、版本变更或其他外部原因导致的使用异常，本站不承担责任。</p>
